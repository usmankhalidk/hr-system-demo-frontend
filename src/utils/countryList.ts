export const COUNTRY_NAME_TO_CODE: Record<string, string> = {
  ...
  "colombia": "CO", "comoros": "KM", "congo": "CG", "congo, democratic republic": "CD", "cook islands": "CK",
  ...
  "guernsey": "GG", "guinea": "GN", "guinea-bissau": "GW", "guyana": "GY", "haiti": "HT", "heard island": "HM",
  ...
  "italy": "IT", "italia": "IT", "jamaica": "JM", "japan": "JP", "jersey": "JE", "jordan": "JO", "kazakhstan": "KZ",
  "kenya": "KE", "kiribati": "KI", "north korea": "KP", "south korea": "KR", "kuwait": "KW", "kyrgyzstan": "KG",
  "lao": "LA", "latvia": "LV", "lebanon": "LB", "lesotho": "LS", "liberia": "LR", "libya": "LY", "liechtenstein": "LI",
  ...
  "mauritania": "MR", "mauritius": "MU", "mayotte": "YT", "mexico": "MX", "micronesia": "FM", "moldova": "MD",
  "monaco": "MC", "mongolia": "MN", "montenegro": "ME", "montserrat": "MS", "morocco": "MA", "mozambique": "MZ",
  "myanmar": "MM", "namibia": "NA", "nauru": "NR", "nepal": "NP", "netherlands": "NL", "new caledonia": "NC",
  ...
  "reunion": "RE", "romania": "RO", "russian federation": "RU", "rwanda": "RW", "saint barthelemy": "BL",
  "saint helena": "SH", "saint kitts and nevis": "KN", "saint lucia": "LC", "saint martin": "MF",
  "saint pierre and miquelon": "PM", "saint vincent": "VC", "samoa": "WS", "san marino": "SM",
  ...
  "somalia": "SO", "south africa": "ZA", "south georgia": "GS", "spain": "ES", "sri lanka": "LK",
  "sudan": "SD", "suriname": "SR", "svalbard": "SJ", "swaziland": "SZ", "sweden": "SE", "switzerland": "CH",
  ...
  "uruguay": "UY", "uzbekistan": "UZ", "vanuatu": "VU", "venezuela": "VE", "viet nam": "VN", "wallis and futuna": "WF",
