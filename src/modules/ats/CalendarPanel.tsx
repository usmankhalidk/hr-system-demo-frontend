...
import { Interview as APIInterview, JobPosting, getAllInterviews, updateInterview, deleteInterview } from '../../api/ats';
...
export default function CalendarPanel({
  ...
  const handleSaveInterview = async (updates: Partial<APIInterview>) => {
    ...
    try {
      const updated = await updateInterview(selectedInterview.id, updates);
          ...
          <div style={{ padding: '24px', display: 'flex', flexDirection: 'column', gap: 20 }}>
            ...
            <div>
              ...
              <CustomSelect
                ...
                onChange={(value) => handleFilterChange('positionId', value === 'all' ? null : parseInt(value, 10))}
            ...
            <div>
              ...
              <CustomSelect
                ...
                onChange={(value) => handleFilterChange('interviewerId', value === 'all' ? null : parseInt(value, 10))}
    ...
    >
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          ...
          >
            {t('ats.interviewCalendar', 'Interview Calendar')}
          </h2>
        </div>
        ...
        >
          <button
            ...
            style={{
              ...
              color: view === 'weekly' ? '#fff' : 'var(--text-secondary)',
              fontSize: '0.8rem',
              fontWeight: 600,
              cursor: 'pointer',
              display: 'flex',
          ...
          <button
            ...
            style={{
              ...
              color: view === 'monthly' ? '#fff' : 'var(--text-secondary)',
              fontSize: '0.8rem',
              fontWeight: 600,
              cursor: 'pointer',
              display: 'flex',
      ...
      >
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          ...
          <Button variant="secondary" onClick={handleToday} style={{ fontSize: '0.8rem', padding: '6px 12px' }}>
            {t('common.today', 'Today')}
          </Button>
        </div>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, flexWrap: 'wrap' }}>
          ...
          <div style={{ minWidth: 160 }}>
            <CustomSelect
              ...
              value={filters.positionId === null ? 'all' : String(filters.positionId)}
              onChange={(value) =>
                handleFilterChange('positionId', value === 'all' ? null : parseInt(value, 10))
              }
              placeholder={t('ats.selectPosition', 'Select Position')}
            />
          </div>
          ...
          <div style={{ minWidth: 160 }}>
            <CustomSelect
              ...
              value={filters.interviewerId === null ? 'all' : String(filters.interviewerId)}
              onChange={(value) =>
                handleFilterChange('interviewerId', value === 'all' ? null : parseInt(value, 10))
              }
              placeholder={t('ats.selectInterviewer', 'Select Interviewer')}
            />
          </div>
          ...
          <div style={{ minWidth: 140 }}>
            <CustomSelect
              ...
              value={filters.status === null ? 'all' : filters.status}
              onChange={(value) =>
                handleFilterChange('status', value === 'all' ? null : (value as Interview['status']))
              }
              placeholder={t('ats.selectStatus', 'Select Status')}
            />
          </div>
      ...
      <div style={{ flex: 1, overflowY: 'auto', background: 'var(--background)' }}>
        {loading ? (
          ...
          <ATSMonthlyCalendar
            ...
            currentDate={currentDate}
            onDayClick={(date) => {
              // Switch to weekly view and navigate to that date
              setCurrentDate(new Date(date));
              setView('weekly');
            }}
            onInterviewClick={handleInterviewClick}
